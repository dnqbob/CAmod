...
WorldLoaded = function()
	...
	ObjectiveEliminateNod = GDI.AddObjective("Lua-enmity-eliminate-all-nod")
	...
	Trigger.AfterDelay(HoldOutTime[Difficulty] - DateTime.Seconds(20), function()
		...
		Notification("Lua-enmity-signal-flare-detected")
	...
	Trigger.AfterDelay(HoldOutTime[Difficulty], function()
		...
		Notification("Lua-enmity-reinforcements-have-arrived")
		Beacon.New(GDI, McvRally.CenterPosition)
		DoReinforcements()
	end)
	...
	Trigger.AfterDelay(DateTime.Minutes(22), function()
		...
		Notification("Lua-enmity-recon-drones-are")
