...
WorldLoaded = function()
	...
	ObjectiveWipeOutVillage = USSR.AddObjective("Lua-prologue-02-wipe-out-village")
	ObjectiveDestroyBase = USSR.AddObjective("Lua-prologue-02-destroy-allied-base")

	Trigger.AfterDelay(DateTime.Seconds(2), function()
		PlaySpeechNotificationToMissionPlayers("ReinforcementsArrived")
		Notification("Lua-prologue-02-reinforcements-arrived")
		DoMcvArrival()
	end)
	...
	Trigger.AfterDelay(DateTime.Minutes(1), function()
		...
		Notification(UserInterface.GetFluentMessage("Lua-prologue-02-signal-flare-detected", { ["0"] = "[" .. UtilsCA.Hotkey("ToLastEvent") .. "]" }))
...
WarpInTeslaTanks = function(TankLocation1, TankLocation2, EffectLocation)
	...
	Trigger.AfterDelay(DateTime.Seconds(2), function()
		Media.DisplayMessage("Lua-prologue-02-greetings-comrades", "Lua-prologue-02-speaker-tesla-tank", HSLColor.FromHex("FF0000"))
		MediaCA.PlaySound(MissionDir .. "/greetings.aud", 2)

		Trigger.AfterDelay(AdjustTimeForGameSpeed(DateTime.Seconds(6)), function()
			Media.DisplayMessage("Lua-prologue-02-doubts-agreement", "Lua-prologue-02-speaker-unknown", HSLColor.FromHex("999999"))
