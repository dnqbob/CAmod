...
{
	class OGroundUnitsIdleState : GroundStateBaseCA, IState
	{
		...
		public void Tick(SquadCA owner)
		{
			...
			if (AttackOrFleeFuzzyCA.Default.CanAttack(owner.Units, enemyUnits))
			{
				...
				owner.FuzzyStateMachine.ChangeState(owner, new OGroundUnitsAttackMoveState(), true);
			}
			else
				owner.FuzzyStateMachine.ChangeState(owner, new OGroundUnitsFleeState(), true);
		}

		public void Deactivate(SquadCA owner) { }
	}

	class OGroundUnitsAttackMoveState : GroundStateBaseCA, IState
	{
		public void Activate(SquadCA owner) { }
		...
		public void Tick(SquadCA owner)
		{
			...
			else
			{
				...
				if (target != null)
				{
					...
					owner.FuzzyStateMachine.ChangeState(owner, new OGroundUnitsAttackState(), true);
				}
				else
	...
	class OGroundUnitsAttackState : GroundStateBaseCA, IState
	{
		public void Activate(SquadCA owner) { }
	...
	class OGroundUnitsFleeState : GroundStateBaseCA, IState
	{
		public void Activate(SquadCA owner) { }
		...
		public void Tick(SquadCA owner)
		{
			...
			owner.FuzzyStateMachine.ChangeState(owner, new OGroundUnitsIdleState(), true);
		}
